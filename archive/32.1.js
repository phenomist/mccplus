...
var mccPlus_Version            = "32.1";
var mccPlus_Version_Date       = "05/20/2015 03:31 PST";
var mccPlus_RBUp = "";
var mccPlus_Raid = "";
var mccPlus_GBUp = "";
var mccPlus_LastClicked = new Date;
var mccPlus_LastDef = new Date;
    ...
    if (cieq(args[0],mccPlus_Username)) {
      switch(command.toLowerCase()) {
        case "afk":
          ...
          break;
        case "def":
          text = args[0] + " has not been attacked for " + timeProcessor(new Date - mccPlus_LastDef);
          break;
        case "load":
