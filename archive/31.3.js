...
var mccPlus_Version            = "31.3";
var mccPlus_Version_Date       = "05/19/2015 15:41 PST";
var mccPlus_RBUp = "";
var mccPlus_Raid = "";
var mccPlus_GBUp = "";
...
mccPlusClient.on('raid_404',function(){
			...
			var template = "{{#or}}
{{#r}}You won the raid against {{u}}! You killed {{eK}} enemies, and lost {{dK}} soldiers. You managed to steal ${{money}} from his storage.{{/r}}
{{^r}}You lost the raid against {{u}}! You killed {{eK}} enemies, and lost {{dK}} soldiers.{{/r}}
{{/or}}";
